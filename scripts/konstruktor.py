...
for x in range(1,TILE_TYPES+1):
	img = pygame.image.load(f'rocky/01. Rocky Level/tiles/{x}.png').convert_alpha()
	img = pygame.transform.scale(img, (TILE_SIZE, TILE_SIZE))
	img_list.append(img)

save_img = pygame.image.load('rocky/01. Rocky Level//save_btn.png').convert_alpha()
load_img = pygame.image.load('rocky/01. Rocky Level//load_btn.png').convert_alpha()
...
while run:
	...
	if save_button.draw(screen):
		#save level data
		with open(f'levelid/level{level}_data.csv', 'w', newline='') as csvfile:
